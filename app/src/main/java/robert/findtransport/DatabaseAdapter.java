...
public class DatabaseAdapter {
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void insertIntoTransport(SQLiteDatabase db) {
            ...
            db.insert(TABLE_TRANSPORT_NAME, null, insertDataToTableTransport("22", "A", "Նոր Նորքի 9-րդ զ/ծ", "Վիլնյուսի փ․", "Նոր Նորքի 8-րդ զ/ծ", "Մինսկի փ․ (Նոր նորքի 8-րդ զ/ծ)", "Միկոյան փ․",
            ...
            db.insert(TABLE_TRANSPORT_NAME, null, insertDataToTableTransport("28", "A", "Նոր Նորքի 8-րդ զ/ծ", "Մինսկի փ․ (Նոր նորքի 8-րդ զ/ծ)", "Միկոյան փ․", "Բադալ Մուրադյան փ․",
            ...
            db.insert(TABLE_TRANSPORT_NAME, null, insertDataToTableTransport("42", "A", "Նոր Նորքի 8-րդ զ/ծ", "Մինսկի փ․ (Նոր նորքի 8-րդ զ/ծ)", "Միկոյան փ․", "Բադալ Մուրադյան փ․",
...
//                    "Վանթյան փ․", "Կուրղինյան փ․", "Սեբաստիայի փ․ (Կուրղինյան խաչմերուկ)", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME, null, insertDataToTableTransport("9", "M", "Ջրվեժ", "Մինսկի փ․ (Նոր նորքի 8-րդ զ/ծ) (Նոր նորքի 8-րդ զ/ծ)", "Միկոյան փ․", "Բադալ Մուրադյան փ․", "Մյասնիկյան պ․ (Ջրաշխարհ)",
            ...
            db.insert(TABLE_TRANSPORT_NAME, null, insertDataToTableTransport("40", "M", "Նոր Նորքի 9-րդ զ/ծ", "Վիլնյուսի փ․", "Մինսկի փ․ (Նոր նորքի 8-րդ զ/ծ)", "Միկոյան փ․", "Գալշոյան փ․",
            ...
            db.insert(TABLE_TRANSPORT_NAME, null, insertDataToTableTransport("58", "M", "Նոր Նորքի 8-րդ զ/ծ", "Մինսկի փ․ (Նոր նորքի 8-րդ զ/ծ)", "Միկոյան փ․", "Բադալ Մուրադյան փ․",
                    "Գայի պ․ (Մերսեդեսի սրահ)", "Գայի պ․ (Գայի արձան)", "Գայի պ․ (Աքվատեք)", "Ռուբինյանց փ․ (Ալմաստ գ/ն)", "Ռուբինյանց փ․ (Երևան Սիթի)",
                    "Ռուբինյանց փ․ (Ահարոնյան փ․)", "Դավիթ Անհաղթի փ․ (Դրոյի խաչմերուկ)", "Դավիթ Անհաղթի փ․ (Կերամա Մարացի)", "Դավիթ Անհաղթի փ․ (թաղապետարան)",
                    "Կոմիտասի պ․ (Լամբադա կամուրջ)", "Կոմիտասի պ․ (Կոմիտասի շուկա)", "Կոմիտասի պ․ (Վրացական խաչմերուկ)", "Կոմիտասի պ․ (Սլավոնական համալսարան)",
                    "Կոմիտասի պ․ (Փափազյան խաչմերուկ)", "Կոմիտասի պ․ (Վաղարշյան խաչմերուկ)", "Կոմիտասի պ․ (Գյուլբենկյան խաչմերուկ)", "Կասյան փ․", "Կիևյան փ․ (Բարեկամություն)",
            ...
            db.insert(TABLE_TRANSPORT_NAME, null, insertDataToTableTransport("62", "M", "Քանաքեռի 13- րդ փ.", "Զաքարիա Քանաքեռցու փ․", "Թբիլիսյան խճ․ (Լամպերի լիճ)",
                    ...
                    "Մաշտոցի պ․ (Մարգարյան հիվ․)", "Մաշտոցի պ․ (Ամիրյան խաչմերուկ)", "Հանրապետության Հրապարակ", "Վազգեն Սարգսյան փ․", "Խորենացու փ․ (Շահումյան հրապ․)", "Ագաթանգեղոսի փ․",
            ...
            //////56A soon
            db.insert(TABLE_TRANSPORT_NAME, null, insertDataToTableTransport("99", "M", "ՀԱԹ", "Առնո Բաբաջանյան փ․", "Րաֆֆու փ․", "Րաֆֆու փ․ (Մալաթիայի շուկա)",
