...
//                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
        ...
        private void insertIntoTransportRu(SQLiteDatabase db) {
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("35", "A", "Нор-Норк 4-й массив", "ул. Гюликехвян", "ул. Галшоян", "ул. Артем Микоян",
                    ...
                    "ул. Раффи", "ул. Зоравар Андраник", "ул. Оганова", "ул. Гусана Шерама", "ул. Арно Бабаджанян", "просп. Исакова", "գ․ ԱրգАванդ", "сл. Геханист",
...
//TODO here
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("47", "A", "сл. Ариндж", "Աճառյան փ.", "Газпром Армения", "Тбилисское шс. (Радиомачта)",
                    ...
                    "ул. Себастия (ярмарка Малатия)", "ул. Раффи (ярмарка Малатия)", "ул. Раффи", "ул. Зоравар Андраник", "ул. Арно Бабаджанян", "Շահումյանի 4-րդ փ․", "Եռաբլուր",
                    "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("53", "A", "Нор-Норк 9-й массив", "ул. Вильнюса", "Нор-Норк 7-й массив", "ул. Унана Аветисяна", "ул. Давид-Бека",
                    ...
                    "ул. Арно Бабаджанян", "Շահումյանի 4-րդ փ․", "Եռաբլուր", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("54", "A", "Аван-Առինջ", "Տաշքենդի փ․", "ул. Маршал Бабаджанян", "ул. Ачаряна", "Ботанический сад",
                    ...
                    "ул. Арташисян", "ул. Ширака (аэропорт Эребуни)", "ул. Араратян", "Ներքին Չարբախի 1-ին փ․", "գ. Նորաբաց", "գ.ԴաշտАван", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("55", "A", "Հայ֊Բելոռուսական ա/կ", "ул. Ширака (рынок Чарбаха)", "ул. Арташисян",
                    "просп. Багратуняц (перекрёсток  Арташисян)", "просп. Багратуняц (Ереван Сити)", "просп. Багратуняц (перекрёсток Исаков)", "ул. Себастия (перекрёсток Кургинян)",
                    ...
                    "ул. Алабян (ТУМО)", "ул. Арзуманян", "ул. Шинарарнери", "Աբելյան փ․", "ул. Алабян (перекрёсток института физики)", "ул. Маргарян (Республиканская больница)", "Ֆուչիկի փ․",
                    "ул. Мелкумова", "кв. Норашен", "16 квартал", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("57", "A", "15-րդ թաղ.", "ул. Мазманян", "ул. Чауша", "ул. Мелкумова", "Ֆուչիկի փ․",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("58", "A", "Эребуни массив", "ул. Хахах Дона", "ул. Титоградян", "ул. Айвазовского", "ул. Эребуни",
                    ...
                    "ул. Рубинянц (завод Алмаст)", "Խուդյակովի փ․", "Թումանյան թաղ.", "ул. Маршал Бабаджанян", "Աշխաբադի փ․", "Аван-Առինջ", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("59", "A", "Аван", "Խուդյակովի փ․", "ул. Алматы", "ул. Маршал Бабаджанян", "ул. Ачаряна",
                    "просп. Мясникяна (Джрашхар)", "просп. Мясникяна (ЗООПАРК)", "просп. Мясникяна (перекрёсток Гераци)", "ул. Абовяна (скверик Абовяна)", "ул. Абовяна (Сельскохозяйственная академия)",
                    "ул. Абовяна (ст/м Еритасардакан (Молодёжная))", "Սայաթ-Նովա պ․ (Աբովյան խաչմերուկ)", "просп. Маштоца (Опера)", "просп. Маштоца (больница им. Маргаряна)", "просп. Маштоца (перекрёсток Амирян)",
                    "ул. Хоренаци (перекрёсток Маштоц)", "ул. Хоренаци (пл. Шаумяна)", "ул. Агатангехоси", "просп. Аршакуняц (Цирк)", "просп. Аршакуняц (т/ц Сурмалу)",
                    "Քրիստափորի փ․", "Փեթակ ա/կ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            ///Temporary unavailable
//            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("62", "A", "Պռոշյան Аван", "Аштаракское шс.", "Մելքումովի փ․", "15 квартал", "ул. Бекназарян", "ул. Мазманян",
...
//                    "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("63", "A", "Нор-Норк 9-й массив", "ул. Вильнюса", "Нор-Норк 7-й массив", "ул. Унана Аветисяна", "ул. Давид-Бека",
                    "ул. Бадала Мурадяна", "просп. Гая (салон Мерседеса)", "просп. Гая (Памятник Гаю)", "просп. Гая (Акватек)", "просп. Мясникяна (Джрашхар)",
                    "просп. Мясникяна (ЗООПАРК)", "просп. Мясникяна (перекрёсток Гераци)", "ул. Абовяна (скверик Абовяна)", "ул. Абовяна (Сельскохозяйственная академия)",
...
//            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("67", "A", "Նազարբեկյան թաղ.", "Новое шоссе Силикян", "ул. Григор Асратян",
...
//                    "Площадь Республики", "просп. Тиграна Меца (ярмарка Фирдуси)", "Педагогический университет", "просп. Тиграна Меца (к/т Айрарат)", "просп. Тиграна Меца (Ташир т/ц)",
//                    "просп. Тиграна Меца (ЮКЖД)", "просп. Тиграна Меца (Каяран) (Станция)", "ул. Арцаха", "Ռոստովյան փ․", "Մուրացանի փ․", "ул. Эребуни", "ул. Атоян", "ул. Айвазовского",
...
//                    "ул. Ванцян", "ул. Кургиняна", "ул. Себастия (перекрёсток Кургинян)", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("68", "A", "Էներգետիկների բանАван", "Էջմիածնի խճ.", "просп. Исакова (перекрёсток Себастия)",
                    ...
                    "просп. Тиграна Меца (Каяран) (Станция)", "ул. Сасунци Давид", "Կուստոյի փ․", "Քաղաքային պանթեոն", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                    "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("259", "A", "Киликия автовокзал", "мост Победы", "просп. Маштоца (магазин РЫБЫ)",
                    ...
                    "просп. Комитаса (Славянский университет)", "просп. Комитаса (перекрёсток Врацакан)", "просп. Комитаса (рынок Комитаса)", "просп. Комитаса (мост Ламбада)",
                    "просп. Азатутян (Райком)", "Тбилисское шс. (электроламповый завод)", "Թբիլիսյան խճ․ (Լամպերի գ/ն)", "Թբիլիսյան խճ․ (Այբ ավագ դպրոց)",
                    "Թբիլիսյան խճ․ (Երևանի Շամպայնի գ/ն)", "Тбилисское шс. (Радиомачта)", "Газпром Армения", "Ариндж молл", "գ․ Վերին Պտղնի", "գ․ Բալահովիտ", "ք․ Աբովյան", "", "", "", "",
                    "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("261", "A", "просп. Тиграна Меца (Каяран) (Станция)", "просп. Тиграна Меца (ЮКЖД)", "просп. Тиграна Меца (Ташир т/ц)",
                    ...
                    "просп. Мясникяна (ЗООПАРК)", "просп. Мясникяна (Джрашхар)", "Ботанический сад", "ул. Ачаряна", "գ․ Վերին Պտղնի", "գ․ Բալահովիտ", "ք․ Աբովյան", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("1", "M", "Էրեբունի օդանավակայան", "пл. Труда (памятник Рабочему)",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("2", "M", "Ուռուցքաբանության ինստիտուտ", "Ֆանարջյան փ․", "ул. Закария Канакерци", "Էզրաս Հասրաթյան փ․",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("3", "M", "15-րդ թաղ.", "ул. Башинджагян", "ул. Маргарян (ПЕГАС)", "ул. Маргарян (Республиканская больница)",
                    "ул. Алабян (перекрёсток института физики)", "ул. Алабян (ТУМО)", "ул. Алабян (Киевский мост)", "ул. Киевян (Киевский мост)", "ул. Киевян (перекрёсток Орбели)",
                    ...
                    "Փափազյան փ․", "Արամ Խաչատրյան փ․", "ул. Риги", "Ռուս-Հայկական համալսարան", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                    "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("5", "M", "Аван", "кв. Дурян", "ул. Нвер Сафарян․", "ул. Маршал Бабаджанян", "ул. Ачаряна",
                    ...
                    "ул. Маргарян (Республиканская больница)", "Ֆուչիկի փ․", "ул. Мелкумова", "Նորաշեն թաղ․", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("6", "M", "Նոր Նորքի 3-րդ զ/ծ", "ул. Гюрджян", "ул. Шопрона", "ул. Бадала Мурадяна",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("6ա", "M", "Эребуни массив", "ул. Хахах Дона", "ул. Титоградян", "ул. Айвазовского",
                    "ул. Эребуни", "ул. Арцаха", "просп. Тиграна Меца (Каяран) (Станция)", "просп. Тиграна Меца (ЮКЖД)", "просп. Тиграна Меца (Ташир т/ц)", "просп. Тиграна Меца (к/т Айрарат)",
                    "Педагогический университет", "просп. Тиграна Меца (ярмарка Фирдуси)", "Площадь Республики", "Նալբանդյան փ․ (Площадь Республики)", "ул. Туманян",
                    "просп. Маштоца (Опера)", "просп. Маштоца (больница им. Маргаряна)", "просп. Маштоца (перекрёсток Амирян)", "ул. Хоренаци (перекрёсток Маштоц)", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                    "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("7", "M", "Нор-Норк 9-й массив", "ул. Вильнюса", "Нор-Норк 7-й массив", "ул. Унана Аветисяна", "ул. Давид-Бека",
                    "ул. Азатамартикнери", "Սասունցի Դավթի փ.", "Արցախի պ.", "мост Встреча", "ул. Гарегина Нжде", "пл. Гарегина Нжде",
                    "просп. Багратуняц (перекрёсток  Арташисян)", "ул. Арташисян", "Չեխովի փ․", "Հ․ул. Г. Овсепян", "Տարոնցու փ․", "Շենգավիթ մ/կ", "Ներքին Շենգավիթի 9-րդ փ.",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("8", "M", "Քանաքեռ ՀԷԿ", "Ղափանցյան փ․", "Ադոնցի փ․", "Կանազ հոսպիտալ", "Շիրվանզադեի փ․",
                    ...
                    "Григор Лусаворич (Мэрия Еревана)", "Գրիգոր Լուսավորիչ (Կրկես)", "просп. Аршакуняц (Цирк)", "просп. Аршакуняц (т/ц Сурмалу)", "просп. Аршакуняц (парк им. Комитаса)",
                    "просп. Аршакуняц (Ереван Молл)", "просп. Аршакуняц (к/т Айреник)", "ул. Гарегина Нжде", "пл. Гарегина Нжде", "ул. Манандян", "Аракс стадион", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("9", "M", "Джрвеж", "ул.Минска  (8-й Норкский массив) (Нор-Норк 8-й массив)", "ул. Артем Микоян",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("10", "M", "пл. Труда (памятник Рабочему)", "просп. Багратуняц (памятник Рабочему)",
                    ...
                    "ул. Нерсисян", "ул. Улнеци", "ул. Паруйра Севака", "ул. Рубинянц (Ереван Сити)", "ул. Рубинянц (завод Алмаст)", "ул. Ачаряна", "Աճառյան փ. 2-րդ փակուղի",
                    "Աղի հանք", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("11", "M", "Վարդաշենի 5-րդ փ.", "ул. Маари", "Նոր Արեշի 50-րդ փ․", "Նոր Արեշի 7-րդ փ․",
                    "Նոր Արեշի 20-րդ փ․", "ул. Азатамартикнери", "ул. Сасунци Давид", "просп. Тиграна Меца (Каяран) (Станция)", "просп. Тиграна Меца (ЮКЖД)", "просп. Тиграна Меца (Ташир т/ц)",
                    "просп. Тиграна Меца (к/т Айрарат)", "ул. Агатангехоси", "Գրիգոր Լուսավորիչ (Կրկես)", "Григор Лусаворич (Мэрия Еревана)", "Զաքյան փ․",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("12", "M", "ул. Лепсиус", "ул. Дро", "ул. Паруйра Севака", "просп. Азатутян (Райком)",
                    ...
                    "ул. Алабян (перекрёсток института физики)", "ул. Маргарян (Республиканская больница)", "ул. Маргарян (ПЕГАС)", "ул. Башинджагян", "ул. Мазманян", "15-րդ թաղ.",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("13", "M", "Ներքին Շենգավիթ", "Թադևոսյան փ․", "просп. Багратуняц (памятник Рабочему)",
                    "пл. Гарегина Нжде", "просп. Багратуняц (перекрёсток  Арташисян)", "просп. Багратуняц (Ереван Сити)", "просп. Багратуняц (перекрёсток Исаков)",
                    "просп. Исакова (перекрёсток Себастия)", "Киликия автовокзал", "просп. Исакова", "мост Победы", "просп. Маштоца (магазин РЫБЫ)",
                    "просп. Маштоца (Крытый рынок)", "просп. Маштоца (перекрёсток Амирян)", "просп. Маштоца (больница им. Маргаряна)", "просп. Маштоца (Опера)", "просп. Баграмян (Опера)",
                    "просп. Баграмян (Конституционный суд)", "просп. Баграмян (Американский университет)", "просп. Баграмян (школа им. Камо)", "просп. Баграмян (SAS)",
                    "ул. Киевян (Барекамутюн)", "ул. Киевян (перекрёсток Орбели)", "ул. Киевян (Киевский мост)", "ул. Алабян (Киевский мост)", "ул. Алабян (ТУМО)",
                    "ул. Алабян (перекрёсток института физики)", "ул. Иосифян", "Давидашен 1-й квартал", "ул. Тиграна Петросяна", "Աղաբաբյան փ․", "Давидашен 1-й квартал", "", "", "", "", "",
                    "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("15", "M", "Аван ", "ул. Маршал Худяков", "ул. Алматы", "ул. Маршал Бабаджанян",
                    ...
                    "просп. Комитаса (рынок Комитаса)", "Գրիբոյեդովի փ․", "Նաիրի Զարյան փ․", "Բորսայի շենք", "ул. Грачья Кочар (перекрёсток Врацакан)",
                    ...
                    "ул. Тиграна Петросяна", "Давидашен 4-й квартал", "Ադոնցի փ․", "просп. Азатутян (Райком)", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                    "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("17", "M", "Արմենալ գ/ն", "Ադոնցի փ․", "просп. Азатутян (Райком)", "просп. Комитаса (мост Ламбада)", "просп. Комитаса (рынок Комитаса)",
                    ...
                    "ул. Себастия (перекрёсток Кургинян)", "просп. Исакова (перекрёсток Себастия)", "Էջմիածնի խճ․", "Զվարթնոց օդանավակայան", "", "", "", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("18", "M", "ул. Абовяна (скверик Абовяна)", "ул. Абовяна (Сельскохозяйственная академия)",
                    ...
                    "просп. Багратуняц (Ереван Сити)", "просп. Багратуняц (перекрёсток Исаков)", "просп. Исакова (перекрёсток Себастия)", "Էջմիածնի խճ․",
                    "Զվարթնոց օդանավակայան", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("19", "M", "Գաջեգործների փ․", "Կուստոյի փ․", "ул. Сасунци Давид", "просп. Тиграна Меца (Каяран) (Станция)",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("22", "M", "Мараш", "Норк 9-ая ул", "Նորքի 7-րդ փ․", "Норк 8-ая ул", "ул. Арменак Арменакяна",
                    "ул. Сараландж", "ул. Гераци", "ул. Чаренца (Полиция РА)", "ул. Налбандян (ЕПТУ)", "ул. Ханджяна (дом Шахмат)", "Вернисаж", "ул. Ханджяна (Лунапарк)",
                    "Педагогический университет", "просп. Тиграна Меца (к/т Айрарат)", "просп. Тиграна Меца (Ташир т/ц)", "Քրիստափորի փ․", "Փեթակ ա/կ", "просп. Аршакуняц (парк им. Комитаса)",
                    "просп. Аршакуняц (Ереван Молл)", "просп. Аршакуняц (к/т Айреник)", "ул. Гарегина Нжде", "Մայիսի 9-ի փ․", "Մուսաելյան փ․", "Օդեսայի փ․",
                    "Արևելյան քաղցրավենիքներ գ/ն", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("23", "M", "просп. Тиграна Меца (Каяран) (Станция)", "просп. Тиграна Меца (ЮКЖД)", "просп. Тиграна Меца (Ташир т/ц)",
                    ...
                    "ул. Раффи", "ул. Гусана Шерама", "ул. Оганова", "գ.Հաղթանակի 1-ին փ․", "գ.Հաղթանակի 6-րդ փ․", "գ.Հաղթանակի 9-րդ փ․", "գ.Հաղթանակի 10-րդ փ․",
                    "գ.Հաղթանակի 7-րդ փ․", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("24", "M", "Նորագյուղ", "Էջմիածնի հին խճ․", "просп. Исакова", "Киликия автовокзал",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("25", "M", "Էլեկտրոն գ/ն", "Շարուրի փ․", "ул. Ширака (рынок Чарбаха)", "ул. Арташисян",
                    "просп. Багратуняц (перекрёсток  Арташисян)", "пл. Гарегина Нжде", "ул. Гарегина Нжде", "мост Встреча", "Ռոստովյան փ․", "ул. Азатамартикнери",
                    "ул. Эребуни", "ул. Айвазовского", "ул. Титоградян", "ул. Хахах Дона", "Эребуни массив", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("26", "M", "Нор-Норк 1-й массив", "Ջուղայի փ․", "ул. Лвовян", "Բորյան փ․", "ул. Нансена",
                    "просп. Гая (Памятник Гаю)", "просп. Гая (салон Мерседеса)", "Բաղյան փ․", "ул. Гюрджян", "Նորքի 1-ին փող. նրբ.", "Նորքի 2-րդ փող. նրբ.", "ул. Г. Овсепян",
                    ...
                    "ул. Московян (Консерватория)", "Մոսկովյան փ․ (Կասկադ)", "Մոսկովյան փ․ (Թումանյան խաչմերուկ)", "Սարյան փ․ (Թումանյան խաչմերուկ)",
                    "Սարյան փ․ (Սարյան փոշտ)", "Սարյան փ․ (Ամիրյան խաչմերուկ)", "просп. Маштоца (Крытый рынок)", "просп. Маштоца (магазин РЫБЫ)",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("27", "M", "Սիլիկյան 7-րդ փ․", "Սիլիկյան 10-րդ փ․", "Новое шоссе Силикян", "ул. Мазманян",
                    ...
                    "ул. Алабян (ТУМО)", "ул. Алабян (Киевский мост)", "ул. Киевян (Киевский мост)", "Օրբելի փ․", "просп. Баграмян (школа им. Камо)",
                    "просп. Баграмян (Американский университет)", "просп. Баграмян (Конституционный суд)", "Մոսկովյան փ․ (Կասկադ)", "просп. Маштоца (Консерватория)",
                    "просп. Маштоца (Матенадаран)", "ул. Корюна (Цитадель)", "Медицинский университет", "ул. Чаренца (Полиция РА)", "ул. Чаренца (ЕГУ)",
                    "ул. Чаренца (салон-магазин Zigzag)", "просп. Саят-Нова (перекрёсток Алек-Манукян)", "ул. Алека Манукяна", "Վարդանանց փ․", "Հանրապետական մ/դ", "", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("28", "M", "Եռաբլուր", "Շահումյանի 4-րդ փ․", "ул. Арно Бабаджанян", "ул. Зоравар Андраник", "ул. Раффи",
                    ...
                    "ул. Сараландж", "просп. Азатутян (Парк Победы)", "просп. Азатутян (Военкомат)", "Վարշավյան փ․", "Ուսումնական հանրակացարաններ", "", "", "", "",
                    "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("29", "M", "Արագածի փ.", "Մայիսի 9-ի փ․", "Չեխովի փ․", "просп. Багратуняц (перекрёсток  Арташисян)",
                    "пл. Гарегина Нжде", "ул. Гарегина Нжде", "просп. Аршакуняц (к/т Айреник)", "просп. Аршакуняц (Ереван Молл)", "просп. Аршакуняц (парк им. Комитаса)",
            ...
            /////29A soon
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("31ա", "M", "Արաքս գ/ն", "Егвардское шс.", "Անաստաս Միկոյան փ․", "Давидашен 4-й квартал",
                    "Դավթաշենի 3-րդ թաղ․", "Արմենիա հ/ը", "ул. Алабян (перекрёсток института физики)", "ул. Маргарян (Республиканская больница)", "ул. Маргарян (ПЕГАС)", "ул. Башинджагян",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("32", "M", "Ариндж молл", "Аван-Առինջ", "Տաշքենդի փ․", "ул. Маршал Бабаджанян", "ул. Алматы", "ул. Маршал Худяков",
                    "ул. Нвер Сафарян․", "кв. Дурян", "Վախթանգովի փ․", "Թոթովենցի փ․", "ул. Степаняна", "просп. Гая (салон Мерседеса)", "ул. Бадала Мурадяна", "ул. Артем Микоян",
                    "ул.Минска  (8-й Норкский массив)", "Нор-Норк 8-й массив", "ул. Вильнюса", "Нор-Норк 7-й массив", "ул. Унана Аветисяна", "ул. Давид-Бека", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                    "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("33", "M", "Аэрация", "Շիրակի 5-րդ նրբ․", "գ. Գեղանիստ", "գ. ԱրգАванդ", "просп. Исакова",
                    ...
                    "просп. Азатутян (Парк Победы)", "просп. Азатутян (Военкомат)", "просп. Азатутян (Наири Зарян перекрёсток)", "просп. Азатутян (Райком)",
                    "ул. Паруйра Севака", "ул. Улнеци", "Էզրաս Հասրաթյան փ․", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            /////10A soon
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("33ա", "M", "Нор-Норк 1-й массив", "Նորք կ/թ", "Ջուղայի փ․", "ул. Нерсон Сафаряна",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("34", "M", "Մարս գ-ն", "ул. Гусана Шерама", "ул. Раффи", "ул. Раффи (ярмарка Малатия)",
                    "ул. Себастия (ярмарка Малатия)", "ул. Себастия (перекрёсток Тычина)", "ул. Себастия (перекрёсток Ленинградян)", "ул. Ленинградян (Евроваген)",
                    ...
                    "ул. Рубинянц (ул. Агаронян)", "ул. Рубинянц (Ереван Сити)", "ул. Рубинянц (завод Алмаст)", "Ծարավ Աղբյուրի փ․", "", "", "", "", "", "", "", "",
                    "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("36", "M", "Սպանդարյան կայարան", "Սիլիկյան 4-րդ փ․", "Սիլիկյան 10-րդ փ․", "Новое шоссе Силикян",
                    "ул. Себастия (перекрёсток Ленинградян)", "ул. Себастия (перекрёсток Тычина)", "ул. Себастия (ярмарка Малатия)", "ул. Раффи (ярмарка Малатия)",
                    "ул. Раффи", "ул. Арно Бабаджанян", "գ.ԱրգАванդ", "գ.Գեղանիստ", "Аэрация", "Շիրակի 5-րդ նրբ.", "ул. Ширака (Ипподром)", "ул. Ширака (рынок Чарбаха)",
                    "Շարուրի փ․", "Էլեկտրոն գ/ն", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("37", "M", "сл. Касах", "Աշտարակի խճ.", "16 квартал", "кв. Норашен", "ул. Чауша", "ул. Мелкумова", "Ֆուչիկի փ․",
                    ...
                    "ул. Арно Бабаджанян", "Էջմիածնի խճ.", "գ․ ԱրգАванդ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("38", "M", "Պրոթեզավորման Կենտրոն", "Ծարավ Աղբյուրի փ․", "ул. Рубинянц (завод Алмаст)",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("39", "M", "ул. Ширака (рынок Чарбаха)", "ул. Арташисян", "просп. Багратуняц (перекрёсток  Арташисян)",
                    "пл. Гарегина Нжде", "ул. Гарегина Нжде", "просп. Аршакуняц (к/т Айреник)", "просп. Аршакуняц (Ереван Молл)", "просп. Аршакуняц (парк им. Комитаса)",
                    "просп. Аршакуняц (т/ц Сурмалу)", "просп. Аршакуняц (Цирк)", "Գրիգոր Լուսավորիչ (Կրկես)", "Григор Лусаворич (Мэрия Еревана)", "Պարոնյան փ․ (Կեսարի պալատ)",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("40", "M", "Нор-Норк 9-й массив", "ул. Вильнюса", "ул.Минска  (8-й Норкский массив)", "ул. Артем Микоян",
                    ...
                    "ул. Рубинянц (Ереван Сити)", "ул. Паруйра Севака", "ул. Улнеци", "Էզրաս Հասրաթյան փ․", "ул. Закария Канакерци", "Тбилисское шс. (Радиомачта)", "Газпром Армения",
                    "Северный автовокзал", "Ариндж молл", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("41", "M", "Էլեկտրոն գ/ն", "Շարուրի փ․", "ул. Ширака (рынок Чарбаха)", "ул. Арташисян",
                    "Մանթաշյան փ․", "Չեխովի փ․", "Մայիսի 9-ի փ․", "ул. Гарегина Нжде", "просп. Аршакуняц (к/т Айреник)", "просп. Аршакуняц (Ереван Молл)",
                    ...
                    "просп. Азатутян (Парк Победы)", "просп. Азатутян (Военкомат)", "просп. Азатутян (Наири Зарян перекрёсток)", "просп. Азатутян (Райком)", "Ադոնցի փ․",
                    "Շիրվանզադեի փ․", "Մամիկոնյանց փ․", "Մալխասյանց փ․", "Հուշանվերների կոմբինատ", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("43", "M", "Lepsius str.", "Զեյթունի 5-րդ փ․", "ул. Дро", "ул. Паруйра Севака", "ул. Улнеци",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("44", "M", "Էներգետիկների բանАван", "Էջմիածնի խճ.", "ул. Арно Бабаджанян", "ул. Зоравар Андраник",
                    "ул. Раффи", "ул. Раффи (ярмарка Малатия)", "ул. Себастия (ярмарка Малатия)", "ул. Себастия (перекрёсток Кургинян)", "просп. Багратуняц (перекрёсток Исаков)",
                    ...
                    "пл. Труда (памятник Рабочему)", "Норагавит 1-ая ул.", "գ. ՄարМарашեն", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                    "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("45", "M", "Эребуни массив ", "ул. Хахах Дона", "ул. Титоградян", "ул. Айвазовского", "ул. Эребуни",
                    ...
                    "ул. Московян (дом Камерной музыки)", "ул. Абовяна (ст/м Еритасардакан (Молодёжная))", "ул. Абовяна (Сельскохозяйственная академия)", "ул. Абовяна (скверик Абовяна)", "ул. Сараландж",
                    "просп. Азатутян (Парк Победы)", "просп. Азатутян (Военкомат)", "просп. Азатутян (Наири Зарян перекрёсток)", "просп. Азатутян (Райком)",
                    "Тбилисское шс. (электроламповый завод)", "ул. Закария Канакерци", "Էզրաս Հասրաթյան փ․", "ул. Улнеци", "Ֆանարջյան փ․", "Ուռուցքաբանության ինստիտուտ", "", "", "", "",
                    "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("46", "M", "Նազարբեկյան թաղ.", "Новое шоссе Силикян", "15 квартал", "ул. Шираза", "ул. Джанибекян", "ул. Шинарарнери",
                    ...
                    "Вернисаж", "Վարդանանց փ․", "ул. Ерванда Кочара", "Սբ. Գրիգոր Լուսավորիչ եկեղեցի", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("47", "M", "Нубарашен 11-ая ул.․", "Нубарашен 9-ая ул.", "Нубарашен 6-ая ул.", "Нубарашен шс.",
                    ...
                    "просп. Тиграна Меца (ЮКЖД)", "Քրիստափորի փ․", "Փեթակ ա/կ", "просп. Аршакуняц (парк им. Комитаса)", "просп. Аршакуняц (Ереван Молл)", "просп. Аршакуняц (к/т Айреник)",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("48", "M", "Գրանդ Քենդի ՀՁ", "Շահул. Амиряна", "просп. Аршакуняц (к/т Айреник)", "ул. Гарегина Нжде",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("49", "M", "Ներքին Շենգավիթի 11-րդ փ.", "Ներքին Շենգավիթի 9-րդ փ.", "Շենգավիթ մ/կ", "Տարոնցու փ․",
                    ...
                    "просп. Баграмян (Конституционный суд)", "просп. Баграмян (Американский университет)", "просп. Баграмян (школа им. Камо)", "просп. Баграмян (SAS)",
                    "ул. Касян", "Մերգելյանի ինստիտուտ", "Հակոբ Հակոբյան փ․", "Արամ Խաչատրյան փ․", "ул. Риги", "Ռուս-Հայկական համալսարան", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("52", "M", "Նազարբեկյան թաղ.", "Новое шоссе Силикян", "15 квартал", "ул. Чауша", "ул. Мелкумова",
                    ...
                    "просп. Аршакуняц (по напр. Чарбах)", "Էրեբունի օդանավակայան", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("52ա", "M", "Նազարբեկյան թաղ.", "ул. Чауша", "ул. Мазманян", "ул. Башинджагян", "ул. Маргарян (ПЕГАС)",
                    ...
                    "ул. Киевян (перекрёсток Орбели)", "ул. Киевян (Барекамутюн)", "Հրաչյա Քոչար փ․ (Գյուլբենկյան խաչմերուկ)", "ул. Грачья Кочар (перекрёсток Вагаршян)",
                    "ул. Грачья Кочар (перекрёсток Папазян)", "ул. Грачья Кочар (перекрёсток Врацакан)", "Բորսայի շենք", "Նաիրի Զարյան փ․", "Գրիբոյեդովի փ․",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("53", "M", "Джрвеж", "ул. Кочинян", "Բագրևանդի փ․", "ул. Молдовакан", "просп. Гая (салон Мерседеса)",
                    "ул. Бадала Мурадяна", "ул. Давид-Бека", "Ռոստովյան փ․", "мост Встреча", "пл. Труда (памятник Рабочему)", "просп. Багратуняц (памятник Рабочему)",
                    "пл. Гарегина Нжде", "Մանանդյան փ․", "Հ․ул. Г. Овсепян", "Չեխովի փ․", "ул. Арташисян", "ул. Оганесяна", "Վերին Չարբախ", "", "", "", "", "", "", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("54", "M", "Давидашен 4-й квартал", "Егвардское шс.", "ул. Тиграна Петросяна", "Давидашен 1-й квартал",
                    "ул. Сасна Црер", "Արմենիա հ/ը", "ул. Алабян (перекрёсток института физики)", "ул. Алабян (ТУМО)", "ул. Алабян (Киевский мост)", "ул. Киевян (Киевский мост)",
                    "ул. Киевян (перекрёсток Орбели)", "ул. Киевян (Барекамутюн)", "просп. Баграмян (SAS)", "просп. Баграмян (школа им. Камо)", "Պռոշյան փ․ ",
                    "Պարոնյան փ․ (Նաիրի բ/կ)", "Պարոնյան փ․ (Կեսարի պալատ)", "Григор Лусаворич (Мэрия Еревана)", "Գրիգոր Լուսավորիչ (Կրկես)", "ул. Агатангехоси",
                    ...
                    "ул. Азатамартикнери", "ул. Эребуни", "музей Эребуни", "ул. Маари", "գ. Ջրաշեն", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("56", "M", "Կաթի կոմբինատ", "գ. Հաղթանակի 8-րդ փ․", "գ. Հաղթանակի 3-րդ փ․",
                    "գ. Հաղթանակի 10-րդ փ․", "գ. Հաղթանակի 9-րդ փ․", "գ. Հաղթանակի 2-րդ փ․", "գ. Հաղթանակի 1-ին փ․", "ул. Оганова", "ул. Зоравар Андраник", "ул. Раффи",
                    "ул. Раффи (ярмарка Малатия)", "ул. Себастия (ярмарка Малатия)", "ул. Себастия (перекрёсток Тычина)", "ул. Себастия (перекрёсток Ленинградян)",
                    "ул. Ленинградян (Евроваген)", "ул. Ленинградян (перекрёсток Шинарарнер)", "ул. Ленинградян (перекрёсток Монте Мелконян)", "ул. Ленинградян (Киевский мост)",
                    "ул. Киевян (Киевский мост)", "ул. Киевян (перекрёсток Орбели)", "ул. Киевян (Барекамутюн)", "Հրաչյա Քոչար փ․ (Գյուլբենկյան խաչմերուկ)",
                    "ул. Грачья Кочар (перекрёсток Вагаршян)", "ул. Грачья Кочар (перекрёсток Папазян)", "ул. Грачья Кочар (перекрёсток Врацакан)", "Բորսայի շենք",
                    "Նաիրի Զարյան փ․", "Գրիբոյեդովի փ․", "просп. Комитаса (рынок Комитаса)", "просп. Комитаса (мост Ламбада)", "ул. Давида Анахта (Административное деление)",
                    "ул. Давида Анахта (Керама Марацци)", "ул. Давида Анахта (перекрёсток Дро)", "ул. Рубинянц (ул. Агаронян)", "ул. Рубинянц (Ереван Сити)",
                    "ул. Рубинянц (завод Алмаст)", "ул. Ачаряна", "ул. Маршал Бабаджанян", "Տաշքենդի փ․", "Аван-Առինջ", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("57", "M", "Դավթաշենի 1-ին թաղ.", "Աղաբաբյան փ․", "ул. Тиграна Петросяна", "ул. Иосифян",
                    "ул. Алабян (перекрёсток института физики)", "ул. Маргарян (Республиканская больница)", "ул. Маргарян (ПЕГАС)", "ул. Башинджагян", "ул. Джанибекян", "ул. Григор Асратян",
                    "ул. Себастия (перекрёсток Ленинградян)", "ул. Себастия (перекрёсток Тычина)", "ул. Себастия (ярмарка Малатия)", "ул. Себастия (перекрёсток Кургинян)",
                    "просп. Багратуняц (перекрёсток Исаков)", "просп. Багратуняц (Ереван Сити)", "просп. Багратуняц (перекрёсток  Арташисян)", "ул. Арташисян",
                    "ул. Ширака (аэропорт Эребуни)", "просп. Аршакуняц (по напр. Чарбах)", "Норагавит 1-ая ул.", "Арташатское шс.", "գ․ Այնթափ", "ք․ Մասիս", "", "", "", "", "", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("59", "M", "м/р Св. Григор Лусаворич", "ул. Гюрджян ", "Բաղյան փ․",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("60", "M", "Նուբարաշենի խճ. (Զորամաս)", "ул. Хачика Даштенца", "музей Эребуни", "ул. Эребуни",
                    "Մուրացանի փ․", "ул. Сасунци Давид", "просп. Тиграна Меца (Каяран) (Станция)", "Քրիստափորի փ․", "ул. Нар-Дос (перекресток Силачи)", "ул. Хоренаци (Силачи)",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("61", "M", "сл. Вардашен", "Վարդաշենի 9-րդ փ.", "Վարդաշենի 6-րդ փ.", "ул. Маари",
                    "музей Эребуни", "ул. Эребуни", "Մուրացանի փ․", "Ռոստովյան փ․", "мост Встреча", "ул. Гарегина Нжде", "пл. Гарегина Нжде",
                    "просп. Багратуняц (памятник Рабочему)", "пл. Труда (памятник Рабочему)", "просп. Аршакуняц (по напр. Чарбах)", "Էրեբունի օդանավակայան", "Վրացական փ․", "", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("62", "M", "Քանաքեռի 13- րդ փ.", "ул. Закария Канакерци", "Тбилисское шс. (электроламповый завод)",
                    "просп. Азатутян (Райком)", "просп. Комитаса (мост Ламбада)", "просп. Комитаса (рынок Комитаса)", "Բորսայի շենք", "ул. Грачья Кочар (перекрёсток Врацакан)",
                    "ул. Грачья Кочар (перекрёсток Папазян)", "ул. Грачья Кочар (перекрёсток Вагаршян)", "Հրաչյա Քոչար փ․ (Գյուլբենկյան խաչմերուկ)", "просп. Баграмян (SAS)",
                    ...
                    "просп. Маштоца (больница им. Маргаряна)", "просп. Маштоца (перекрёсток Амирян)", "Площадь Республики", "Վազգեն Սարգսյան փ․", "ул. Хоренаци (пл. Шаумяна)",
                    "ул. Агатангехоси", "Педагогический университет", "просп. Тиграна Меца (к/т Айрарат)", "просп. Тиграна Меца (Ташир т/ц)", "ул. Ерванда Кочара", "Սբ. Գրիգոր Լուսավորիչ եկեղեցի",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("64", "M", "16 квартал", "кв. Норашен", "ул. Мелкумова", "ул. Бекназарян", "ул. Башинджагян",
                    ...
                    "Պռոշյան փ․ ", "Պարոնյան փ․ (Նաիրի բ/կ)", "Պարոնյան փ․ (Կեսարի պալատ)", "Григор Лусаворич (Мэрия Еревана)", "Գրիգոր Լուսավորիչ (Կրկես)",
                    "ул. Агатангехоси", "просп. Тиграна Меца (к/т Айрарат)", "просп. Тиграна Меца (Ташир т/ц)", "ул. Ерванда Кочара", "Ալեք Մանուկյան փ․", "ԵՊՀ", "", "", "", "", "", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("65", "M", "Аэрация", "Շիրակի 5-րդ նրբ․", "ул. Ширака (Ипподром)", "ул. Ширака (рынок Чарбаха)",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("67", "M", "ул. Араратян", "ул. Ширака (аэропорт Эребуни)", "ул. Арташисян",
                    ...
                    "ул. Арно Бабаджанян", "Էջմիածնի խճ․", "գ. Փարաքար", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                    "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("68", "M", "Эребуни массив ", "ул. Хахах Дона", "ул. Титоградян", "ул. Айвазовского", "ул. Эребуни",
                    "ул. Азатамартикнери", "ул. Сасунци Давид", "просп. Тиграна Меца (Каяран) (Станция)", "просп. Тиграна Меца (ЮКЖД)", "просп. Тиграна Меца (Ташир т/ц)",
                    "просп. Тиграна Меца (к/т Айрарат)", "Педагогический университет", "ул. Агатангехоси", "Գրիգոր Լուսավորիչ (Կրկես)", "Григор Лусаворич (Мэрия Еревана)",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("72", "M", "գ․ ՄուշАван", "գ․ Վարդաշեն", "ул. Маари", "музей Эребуни", "ул. Эребуни",
                    "ул. Азатамартикнери", "ул. Сасунци Давид", "ул. Арцаха", "мост Встреча", "ул. Гарегина Нжде", "пл. Гарегина Нжде",
                    "просп. Багратуняц (перекрёсток  Арташисян)", "просп. Багратуняц (Ереван Сити)", "просп. Багратуняц (перекрёсток Исаков)", "ул. Себастия (перекрёсток Кургинян)",
                    "ул. Себастия (ярмарка Малатия)", "ул. Раффи (ярмарка Малатия)", "ул. Раффи", "ул. Гусана Шерама", "ул. Тичина", "Ռոմանոս Մելիքյան փ․", "", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("73", "M", "Эребуни массив ", "ул. Хахах Дона", "ул. Титоградян", "ул. Айвазовского", "ул. Эребуни",
                    ...
                    "Педагогический университет", "ул. Ханджяна (Лунапарк)", "Вернисаж", "ул. Ханджяна (дом Шахмат)", "ул. Московян (дом Камерной музыки)",
                    "ул. Абовяна (ст/м Еритасардакан (Молодёжная))", "ул. Абовяна (Сельскохозяйственная академия)", "ул. Абовяна (скверик Абовяна)", "просп. Мясникяна (перекрёсток Гераци)",
                    "просп. Мясникяна (ЗООПАРК)", "просп. Мясникяна (Джрашхар)", "просп. Гая (Памятник Гаю)", "просп. Гая (салон Мерседеса)", "Բաղյան փ․", "ул. Гюрджян",
                    "ул. Шопрона", "ул. Давид-Бека", "ул. Унана Аветисяна", "Нор-Норк 7-й массив", "ул. Вильнюса", "Нор-Норк 9-й массив", "", "", "", "", "", "", "", "", "", "", "", "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("74", "M", "գ․ Զովունի", "Егвардское шс.", "Զովունի 6-րդ փ․", "Զովունի 39-րդ փ․", "Զովունի 8-րդ փ․",
                    ...
                    "Григор Лусаворич (Мэрия Еревана)", "Գրիգոր Լուսավորիչ (Կրկես)", "ул. Агатангехоси", "просп. Тиграна Меца (к/т Айрарат)", "просп. Тиграна Меца (Ташир т/ц)",
                    "просп. Тиграна Меца (ЮКЖД)", "Քրիստափորի փ․", "Փեթակ ա/կ", "просп. Аршакуняц (парк им. Комитаса)", "просп. Аршакуняц (Ереван Молл)", "просп. Аршакуняц (к/т Айреник)",
                    "мост Встреча", "Ռոստովյան փ․", "ул. Атоян", "ул. Эребуни", "ул. Айвазовского", "ул. Титоградян", "ул. Хахах Дона", "Эребуни массив", "", "", "", "", "",
                    "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("75", "M", "ул. Тичина", "ул. Зоравар Андраник", "ул. Оганова", "ул. Гусана Шерама", "ул. Раффи",
                    ...
                    "Медицинский университет", "ул. Чаренца (Полиция РА)", "ул. Гераци", "ул. Арменак Арменакяна", "Նորքի այգիներ 1-ին անցուղի", "Նորք-Мараш բ/կ", "", "", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("76", "M", "Юго-Западный квартал (Бангладеш)", "ул. Зоравар Андраник", "ул. Раффи", "ул. Раффи (ярмарка Малатия)",
                    ...
                    "Ալեք Մանուկյան փ․", "ул. Ерванда Кочара", "просп. Тиграна Меца (Ташир т/ц)", "Քրիստափորի փ․", "Փեթակ ա/կ", "Սևանի փ․", "", "", "", "", "", "", "", "", "", "", "",
                    "", ""));

            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("77", "M", "Аван-Առինջ", "Տաշքենդի փ․", "ул. Маршал Бабаджанян", "ул. Маршал Худяков",
            ...
            //////56A soon
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("99", "M", "Юго-Западный квартал (Бангладеш)", "Եռաբլուր", "Շահումյանի 4-րդ փ․", "ул. Арно Бабаджанян", "ул. Раффи", "ул. Раффи (ярмарка Малатия)",
                    ...
                    "ул. Абовяна (скверик Абовяна)", "ул. Сараландж", "просп. Азатутян (Парк Победы)", "просп. Азатутян (Военкомат)", "просп. Азатутян (Наири Зарян перекрёсток)",
                    "просп. Азатутян (Райком)", "ул. Нерсисян", "Քանաքեռ-Զեյթուն բ/կ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
...
//                    "Գրիգոր Լուսավորիչ (Կրկես)", "ул. Агатангехоси", "просп. Тиграна Меца (к/т Айрарат)", "просп. Тиграна Меца (Ташир т/ц)", "ул. Ерванда Кочара", "ул. Алека Манукяна",
...
//                    "ул. Корюна (Цитадель)", "ул. Терян", "ул. Абовяна (скверик Абовяна)", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            ///25A soon
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("114", "M", "ул. Давида Анахта (Керама Марацци)", "ул. Улнеци (Դեպի Մոնումենտ)",
                    "ул. Генерала Бабаяна", "просп. Азатутян (Военкомат)", "просп. Азатутян (Наири Зарян перекрёсток)", "просп. Комитаса (мост Ламбада)",
                    "просп. Комитаса (рынок Комитаса)", "Գրիբոյեդովի փ․", "Նաիրի Զարյան փ․", "Բորսայի շենք", "ул. Грачья Кочар (перекрёсток Врацакан)",
                    "ул. Грачья Кочар (перекрёсток Папазян)", "ул. Грачья Кочар (перекрёсток Вагаршян)", "Հրաչյա Քոչար փ․ (Գյուլբենկյան խաչմերուկ)",
                    "ул. Киевян (Барекамутюн)", "ул. Киевян (перекрёсток Орбели)", "ул. Киевян (Киевский мост)", "ул. Ленинградян (Киевский мост)",
                    "ул. Ленинградян (перекрёсток Монте Мелконян)", "ул. Ленинградян (перекрёсток Шинарарнер)", "ул. Ленинградян (Евроваген)", "ул. Григор Асратян",
                    "ул. Шираза", "15 квартал", "ул. Чауша", "Аштаракское шс.", "Պռոշյան Аван", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("1", "T", "пл. Труда (памятник Рабочему)", "просп. Багратуняц (памятник Рабочему)", "пл. Гарегина Нжде",
                    "ул. Гарегина Нжде", "просп. Аршакуняц (к/т Айреник)", "просп. Аршакуняц (Ереван Молл)", "просп. Аршакуняц (парк им. Комитаса)", "просп. Аршакуняц (т/ц Сурмалу)",
                    "просп. Аршакуняц (Цирк)", "Գրիգոր Լուսավորիչ (Կրկես)", "Григор Лусаворич (Мэрия Еревана)", "просп. Маштоца (магазин РЫБЫ)", "просп. Маштоца (Крытый рынок)",
                    "просп. Маштоца (перекрёсток Амирян)", "просп. Маштоца (больница им. Маргаряна)", "просп. Маштоца (Опера)", "просп. Маштоца (Консерватория)", "просп. Маштоца (Матенадаран)", "Ցիտադել",
                    ...
                    "ул. Кочинян", "Джрвеж", "", "", "", "", "", "", "", "", "", "", "", ""));
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("2", "T", "ул. Арташисян", "ул. Ширака (рынок Чарбаха)", "Չեխովի փ․", "просп. Багратуняц (перекрёсток  Арташисян)",
                    "Գարեգին Նժդեհի հրապ․", "просп. Багратуняц (памятник Рабочему)", "пл. Труда (памятник Рабочему)", "просп. Аршакуняц (к/т Айреник)", "просп. Аршакуняц (Ереван Молл)",
...
//                    "Вернисаж", "ул. Ханджяна (Лунапарк)", "Педагогический университет", "просп. Тиграна Меца (к/т Айрарат)", "просп. Тиграна Меца (Ташир т/ц)", "просп. Тиграна Меца (ЮКЖД)", "просп. Тиграна Меца (Каяран) (Станция)",
//                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("9", "T", "Аван", "ул. Маршал Бабаджанян", "ул. Ачаряна", "Ботанический сад", "ул. Рубинянц (завод Алмаст)",
                    "ул. Рубинянц (Ереван Сити)", "ул. Рубинянц (ул. Агаронян)", "ул. Давида Анахта (перекрёсток Дро)", "ул. Давида Анахта (Керама Марацци)", "Դավիթ Անհաղթի փպ․ (թաղապետարան)",
                    "просп. Комитаса (мост Ламбада)", "просп. Комитаса (рынок Комитаса)", "просп. Комитаса (перекрёсток Врацакан)", "просп. Комитаса (Славянский университет)",
                    ...
                    "просп. Баграмян (школа им. Камо)", "просп. Баграмян (Американский университет)", "просп. Баграмян (Конституционный суд)", "просп. Баграмян (Опера)",
                    "просп. Саят-Нова (перекрёсток Налбандян)", "Вернисаж", "ул. Ханджяна (Лунапарк)", "Педагогический университет", "ул. Агатангехоси", "Գրիգոր Լուսավորիչ փ․ (Կրկես)",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("10", "T", "Նոր Նորքի 5-րդ զ/ծ", "ул. Бадала Мурадяна", "просп. Гая (салон Мерседеса)",
            ...
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("15", "T", "15 квартал", "ул. Мазманян", "ул. Шираза", "ул. Григор Асратян",
                    "ул. Себастия (перекрёсток Ленинградян)", "ул. Себастия (перекрёсток Тычина)", "ул. Себастия (ярмарка Малатия)", "Սեբաստիայի փ․ (Կուրղինյան)",
                    "просп. Багратуняц (перекрёсток Исаков)", "просп. Багратуняц (Ереван Сити)", "просп. Багратуняц (перекрёсток  Арташисян)", "Գարեգին Նժդեհի հրապ․",
                    "просп. Багратуняц (памятник Рабочему)", "пл. Труда (памятник Рабочему)", "просп. Аршакуняц (по напр. Чарбах)", "Էրեբունի օդանավակայան",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("23", "T", "Джрвеж", "ул. Кочинян", "ул. Тевосяна", "ул. Бадала Мурадяна", "просп. Гая (салон Мерседеса)",
                    ...
                    "просп. Тиграна Меца (ярмарка Фирдуси)", "Մելիք-Ադամյան փ․", "ул. Налбандян (ЕПТУ)", "ул. Московян (дом Камерной музыки)", "", "", "", "", "", "", "", "", "", "", "", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", ""));
            db.insert(TABLE_TRANSPORT_NAME_RU, null, insertDataToTableTransport("24", "T", "Юго-Западный квартал (Бангладеш)", "ул. Раффи", "ул. Раффи (ярмарка Малатия)", "ул. Себастия (ярмарка Малатия)",
                    "Սեբաստիայի փ․ (Կուրղինյան)", "просп. Исакова", "Киликия автовокзал", "Հաղթանակի կ/ջ", "просп. Маштоца (магазин РЫБЫ)", "просп. Маштоца (Крытый рынок)", "просп. Маштоца (перекрёсток Амирян)",
                    "просп. Маштоца (больница им. Маргаряна)", "просп. Маштоца (Опера)", "Օպերա", "просп. Маштоца (Консерватория)", "Մոսկովյան փ․ (Երիտասարդական մ/կ)", "ул. Абовяна (ст/м Еритасардакан (Молодёжная))",
